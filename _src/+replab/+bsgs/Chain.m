...
%    :class: collapsed
%
%    - `~+replab.+bsgs.Chain.B` -- row vector of base points (all between 1..n without duplicates)
%    - `~+replab.+bsgs.Chain.Chain` -- Constructs an empty mutable chain for a subgroup of the permutation group
%    - `~+replab.+bsgs.Chain.Delta` -- row cell array of orbits, each orbit is a row double vector with orbit elements sorted according to the base order
%    - `~+replab.+bsgs.Chain.J` -- image group
%    - `~+replab.+bsgs.Chain.S` -- n x nS matrix of strong generators stored as columns vectors (nS = # of strong generators)
%    - `~+replab.+bsgs.Chain.Sind` -- starting index of strong generators for each stabilizer subgroup, of length k+1 if k = length(B)
%    - `~+replab.+bsgs.Chain.T` -- row cell array of images of strong generators
%    - `~+replab.+bsgs.Chain.U` -- row cell array of transversal elements stored as n x orbitSize matrices
%    - `~+replab.+bsgs.Chain.Uinv` -- row cell array of inverse transversal elements
%    - `~+replab.+bsgs.Chain.V` -- row cell array of row cell arrays of transversal images
%    - `~+replab.+bsgs.Chain.Vinv` -- row cell array of row cell arrays of inverse transversal images
%    - `~+replab.+bsgs.Chain.addStrongGenerator` -- Adds a strong generator at a particular place in the BSGS chain
%    - `~+replab.+bsgs.Chain.additionalFields` -- Returns the name/value pairs corresponding to additional fields to be printed
%    - `~+replab.+bsgs.Chain.bo` -- base order, i.e. for each domain element, gives its order
%    - `~+replab.+bsgs.Chain.boinv` -- inverse permutation of bo, permutation that starts with B and then the remaining domain elements increasing
%    - `~+replab.+bsgs.Chain.check` -- 
%    - `~+replab.+bsgs.Chain.checkStrongGenerators` -- Performs checks on the strong generators of the current chain
%    - `~+replab.+bsgs.Chain.checkTransversals` -- 
%    - `~+replab.+bsgs.Chain.completeOrbit` -- Completes the i-th orbit
%    - `~+replab.+bsgs.Chain.contains` -- Tests whether the BSGS chain contains an element
%    - `~+replab.+bsgs.Chain.disp` -- 
%    - `~+replab.+bsgs.Chain.elementFromIndex` -- Return the element corresponding to an overall index
%    - `~+replab.+bsgs.Chain.elementFromIndices` -- Computes the group element from transversal indices
%    - `~+replab.+bsgs.Chain.eq` -- Equality test
%    - `~+replab.+bsgs.Chain.headerStr` -- Tiny single line description of the current object type
%    - `~+replab.+bsgs.Chain.hiddenFields` -- Returns the names of the fields that are not printed as a row vector
%    - `~+replab.+bsgs.Chain.image` -- Returns the image of a chain element
%    - `~+replab.+bsgs.Chain.imageFromIndex` -- Return the image corresponding to an overall index
%    - `~+replab.+bsgs.Chain.imageFromIndices` -- Computes the image from transversal indices
%    - `~+replab.+bsgs.Chain.imagesDecomposition` -- Returns the homomorphism group images into a product of transversals
%    - `~+replab.+bsgs.Chain.indexFromElement` -- Returns the index corresponding to a group element
%    - `~+replab.+bsgs.Chain.indexFromIndices` -- Returns the overall index corresponding to the given indices vector
%    - `~+replab.+bsgs.Chain.indicesFromElement` -- Computes the transversal indices decomposition for a group element
%    - `~+replab.+bsgs.Chain.indicesFromIndex` -- Return the indices vector corresponding to an overall index
%    - `~+replab.+bsgs.Chain.insertEndBasePoint` -- Adds a new basis point at the end of the BSGS chain
%    - `~+replab.+bsgs.Chain.insertInOrbit` -- Inserts a new orbit element in an orbit
%    - `~+replab.+bsgs.Chain.insertStrongGenerators` -- Inserts the given strong generators
%    - `~+replab.+bsgs.Chain.inverseImage` -- Returns the inverse image of a chain element
%    - `~+replab.+bsgs.Chain.isMutable` -- whether the chain can be modified
%    - `~+replab.+bsgs.Chain.length` -- Returns the length of this BSGS chain
%    - `~+replab.+bsgs.Chain.longStr` -- Multi-line description of the current object
%    - `~+replab.+bsgs.Chain.make` -- 
%    - `~+replab.+bsgs.Chain.makeImmutable` -- 
%    - `~+replab.+bsgs.Chain.makeWithImages` -- 
%    - `~+replab.+bsgs.Chain.mutableMapImages` -- Maps in place the homomorphism images
%    - `~+replab.+bsgs.Chain.n` -- domain size
%    - `~+replab.+bsgs.Chain.nStrongGenerators` -- Returns the number of strong generators in this BSGS chain
%    - `~+replab.+bsgs.Chain.orbitIndex` -- Looks up an orbit element
%    - `~+replab.+bsgs.Chain.orbitSizes` -- 
%    - `~+replab.+bsgs.Chain.order` -- Returns the order of this BSGS chain
%    - `~+replab.+bsgs.Chain.randomTransversal` -- Returns a random transversal element from a specific transversal set
%    - `~+replab.+bsgs.Chain.randomTransversalWithImage` -- Returns a random transversal element from a specific transversal set along with its image
%    - `~+replab.+bsgs.Chain.randomizedSchreierSims` -- Runs the randomized Schreier-Sims algorithm
%    - `~+replab.+bsgs.Chain.recomputeBaseOrder` -- Recomputes the base order, and reorders all orbits according to the corrected base order
%    - `~+replab.+bsgs.Chain.reorderOrbit` -- Reorders the i-th orbit elements according to the base order
%    - `~+replab.+bsgs.Chain.sampleUniformly` -- Samples an element uniformly from the group
%    - `~+replab.+bsgs.Chain.sampleUniformlyWithImage` -- Samples an element uniformly from the group along with its image
%    - `~+replab.+bsgs.Chain.shortStr` -- Single line text description of the current object
%    - `~+replab.+bsgs.Chain.strip` -- Strips a permutation through the chain
%    - `~+replab.+bsgs.Chain.stripAndAddStrongGenerator` -- Strips and, when relevant, adds a new strong generator to this BSGS chain
%    - `~+replab.+bsgs.Chain.stripWithImage` -- Strips a permutation through the chain along with its image
%    - `~+replab.+bsgs.Chain.strongGenerator` -- Returns the i-th strong generator
%    - `~+replab.+bsgs.Chain.strongGeneratorImage` -- Returns the image of the i-th strong generator under the stored homomorphism
%    - `~+replab.+bsgs.Chain.u` -- Looks up a transversal element that maps beta_i to b
%    - `~+replab.+bsgs.Chain.uinv` -- Looks up the inverse transversal element that maps b to beta_i
%    - `~+replab.+bsgs.Chain.v` -- Looks up the image of the transversal element that maps beta_i to b
%    - `~+replab.+bsgs.Chain.vinv` -- Looks up the image of the inverse transversal element that maps b to beta_i
%
