...
%    :class: collapsed
%
%    - `~+replab.+bsgs.RandomBag.J` -- Image group
%    - `~+replab.+bsgs.RandomBag.RandomBag` -- Constructs a random bag from the given permutations
%    - `~+replab.+bsgs.RandomBag.additionalFields` -- Returns the name/value pairs corresponding to additional fields to be printed
%    - `~+replab.+bsgs.RandomBag.compose` -- Duplicates self.Permutations(n).compose to avoid reference loops
%    - `~+replab.+bsgs.RandomBag.disp` -- 
%    - `~+replab.+bsgs.RandomBag.eq` -- Equality test
%    - `~+replab.+bsgs.RandomBag.headerStr` -- Tiny single line description of the current object type
%    - `~+replab.+bsgs.RandomBag.hiddenFields` -- Returns the names of the fields that are not printed as a row vector
%    - `~+replab.+bsgs.RandomBag.inverse` -- Duplicates self.Permutations(n).inverse to avoid reference loops
%    - `~+replab.+bsgs.RandomBag.longStr` -- Multi-line description of the current object
%    - `~+replab.+bsgs.RandomBag.n` -- domainSize
%    - `~+replab.+bsgs.RandomBag.sample` -- 
%    - `~+replab.+bsgs.RandomBag.shortStr` -- Single line text description of the current object
%    - `~+replab.+bsgs.RandomBag.x` -- n x r matrix representing the contents of the bag
%    - `~+replab.+bsgs.RandomBag.x0` -- Last generated sample
%    - `~+replab.+bsgs.RandomBag.y` -- Images of x
%    - `~+replab.+bsgs.RandomBag.y0` -- Image of last generated sample
%
