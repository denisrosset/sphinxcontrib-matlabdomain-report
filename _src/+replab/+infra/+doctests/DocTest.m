...
%    :class: collapsed
%
%    - `~+replab.+infra.+doctests.DocTest.DocTest` -- 
%    - `~+replab.+infra.+doctests.DocTest.additionalFields` -- Returns the name/value pairs corresponding to additional fields to be printed
%    - `~+replab.+infra.+doctests.DocTest.commands` -- row cell vector of row vector of charstring: commands to be evaluated
%    - `~+replab.+infra.+doctests.DocTest.disp` -- 
%    - `~+replab.+infra.+doctests.DocTest.eq` -- Equality test
%    - `~+replab.+infra.+doctests.DocTest.flags` -- row cell vector of struct: flags corresponding to the command evaluation
%    - `~+replab.+infra.+doctests.DocTest.headerStr` -- Tiny single line description of the current object type
%    - `~+replab.+infra.+doctests.DocTest.hiddenFields` -- Returns the names of the fields that are not printed as a row vector
%    - `~+replab.+infra.+doctests.DocTest.isSingleLineCommand` -- 
%    - `~+replab.+infra.+doctests.DocTest.lineNumbers` -- row vector of integer: 1-based line numbers of first line of the command
%    - `~+replab.+infra.+doctests.DocTest.longStr` -- Multi-line description of the current object
%    - `~+replab.+infra.+doctests.DocTest.mapLineNumbers` -- Returns a new `.DocTest` with the line numbers mapped according to the given function
%    - `~+replab.+infra.+doctests.DocTest.nCommands` -- 
%    - `~+replab.+infra.+doctests.DocTest.outputs` -- row cell vector of row vector of charstring: expected output
%    - `~+replab.+infra.+doctests.DocTest.parse` -- Parses a doctest, containing multiple command/output pairs
%    - `~+replab.+infra.+doctests.DocTest.parseCommandOutputPair` -- Parses a command/output pair, where the output may be omitted, and each can be multiline
%    - `~+replab.+infra.+doctests.DocTest.quotedCommand` -- 
%    - `~+replab.+infra.+doctests.DocTest.quotedOutput` -- 
%    - `~+replab.+infra.+doctests.DocTest.shortStr` -- Single line text description of the current object
%
