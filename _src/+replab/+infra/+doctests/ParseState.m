...
%    :class: collapsed
%
%    - `~+replab.+infra.+doctests.ParseState.ParseState` -- 
%    - `~+replab.+infra.+doctests.ParseState.additionalFields` -- Returns the name/value pairs corresponding to additional fields to be printed
%    - `~+replab.+infra.+doctests.ParseState.comments` -- row cell array of charstring: Comments
%    - `~+replab.+infra.+doctests.ParseState.disp` -- 
%    - `~+replab.+infra.+doctests.ParseState.eq` -- Equality test
%    - `~+replab.+infra.+doctests.ParseState.expect` -- Equivalent to `take`, conditioned on the consumed tag to be ``expectedTag``
%    - `~+replab.+infra.+doctests.ParseState.fromDocTestBlock` -- Constructs a ParseState instance from a doctest block lines
%    - `~+replab.+infra.+doctests.ParseState.headerStr` -- Tiny single line description of the current object type
%    - `~+replab.+infra.+doctests.ParseState.hiddenFields` -- Returns the names of the fields that are not printed as a row vector
%    - `~+replab.+infra.+doctests.ParseState.lineNumbers` -- row vector of integer: Original position of remaining lines
%    - `~+replab.+infra.+doctests.ParseState.lines` -- row cell array of charstring: Content lines
%    - `~+replab.+infra.+doctests.ParseState.longStr` -- Multi-line description of the current object
%    - `~+replab.+infra.+doctests.ParseState.pos` -- integer: Current line position
%    - `~+replab.+infra.+doctests.ParseState.shortStr` -- Single line text description of the current object
%    - `~+replab.+infra.+doctests.ParseState.tags` -- row cell array of charstring: Tag describing the line type
%    - `~+replab.+infra.+doctests.ParseState.take` -- Consumes a line from the input, and returns the updated parser state
%
