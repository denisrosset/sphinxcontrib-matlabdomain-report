...
%    :class: collapsed
%
%    - `~+replab.+infra.CodeBase.CodeBase` -- 
%    - `~+replab.+infra.CodeBase.additionalFields` -- Returns the name/value pairs corresponding to additional fields to be printed
%    - `~+replab.+infra.CodeBase.allClasses` -- Returns all classes present in this code base
%    - `~+replab.+infra.CodeBase.allFunctions` -- Returns all functions present in this code base
%    - `~+replab.+infra.CodeBase.allPackages` -- Returns all packages present in this code base
%    - `~+replab.+infra.CodeBase.disp` -- 
%    - `~+replab.+infra.CodeBase.eq` -- Equality test
%    - `~+replab.+infra.CodeBase.get` -- 
%    - `~+replab.+infra.CodeBase.getIdentifier` -- 
%    - `~+replab.+infra.CodeBase.headerStr` -- Tiny single line description of the current object type
%    - `~+replab.+infra.CodeBase.hiddenFields` -- Returns the names of the fields that are not printed as a row vector
%    - `~+replab.+infra.CodeBase.longStr` -- Multi-line description of the current object
%    - `~+replab.+infra.CodeBase.package` -- 
%    - `~+replab.+infra.CodeBase.packages` -- struct-based hash map
%    - `~+replab.+infra.CodeBase.root` -- 
%    - `~+replab.+infra.CodeBase.rootFolder` -- charstring: Path to the root folder
%    - `~+replab.+infra.CodeBase.shortStr` -- Single line text description of the current object
%    - `~+replab.+infra.CodeBase.subclasses` -- Returns the direct subclasses of the given class
%    - `~+replab.+infra.CodeBase.subclasses_` -- struct-based hash map: Maps class paths to a cell array of their subclasses
%    - `~+replab.+infra.CodeBase.subpackages` -- Returns the direct subpackages of the given package
%    - `~+replab.+infra.CodeBase.subpackages_` -- struct-based hash map: Maps package paths to a cell array of their subpackages
%
