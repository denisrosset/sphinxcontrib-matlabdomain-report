...
%    :class: collapsed
%
%    - `~+replab.+infra.CodeTokens.CodeTokens` -- 
%    - `~+replab.+infra.CodeTokens.additionalFields` -- Returns the name/value pairs corresponding to additional fields to be printed
%    - `~+replab.+infra.CodeTokens.disp` -- 
%    - `~+replab.+infra.CodeTokens.eq` -- Equality test
%    - `~+replab.+infra.CodeTokens.expect` -- Equivalent to `take`, conditioned on the consumed tag to be `expectedTag`
%    - `~+replab.+infra.CodeTokens.filename` -- charstring: Filename or ``[]``
%    - `~+replab.+infra.CodeTokens.fromFile` -- Constructs a CodeTokens instance from the contents of the given filename
%    - `~+replab.+infra.CodeTokens.fromSource` -- Constructs a CodeTokens instance from the source code
%    - `~+replab.+infra.CodeTokens.headerStr` -- Tiny single line description of the current object type
%    - `~+replab.+infra.CodeTokens.hiddenFields` -- Returns the names of the fields that are not printed as a row vector
%    - `~+replab.+infra.CodeTokens.lex` -- Constructs a CodeTokens instance from source code lines
%    - `~+replab.+infra.CodeTokens.lines` -- row cell array of charstring: Source code lines
%    - `~+replab.+infra.CodeTokens.longStr` -- Multi-line description of the current object
%    - `~+replab.+infra.CodeTokens.nLines` -- Returns the number of actual lines, not counting the "end of file" added line
%    - `~+replab.+infra.CodeTokens.parse` -- 
%    - `~+replab.+infra.CodeTokens.peek` -- Peeks at the tag of the next line to be consumed, without consuming it
%    - `~+replab.+infra.CodeTokens.shortStr` -- Single line text description of the current object
%    - `~+replab.+infra.CodeTokens.sourceIdentifier` -- Returns the source identifier, i.e. the name of the .m file without extension
%    - `~+replab.+infra.CodeTokens.tags` -- charstring: Tag describing the line type, one char per tag
%    - `~+replab.+infra.CodeTokens.take` -- Consumes a line from the input, and returns the updated parser state
%
