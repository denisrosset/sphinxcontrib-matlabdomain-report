...
%    :class: collapsed
%
%    - `~+replab.+infra.FunctionLikeData.FunctionLikeData` -- 
%    - `~+replab.+infra.FunctionLikeData.additionalFields` -- Returns the name/value pairs corresponding to additional fields to be printed
%    - `~+replab.+infra.FunctionLikeData.attributes` -- struct: Attributes from the ``methods`` block (or ``[]`` if this describes a function)
%    - `~+replab.+infra.FunctionLikeData.declaration` -- charstring: Function or method declaration line
%    - `~+replab.+infra.FunctionLikeData.declarationLineNumber` -- integer: Line number of the declaration
%    - `~+replab.+infra.FunctionLikeData.disp` -- 
%    - `~+replab.+infra.FunctionLikeData.docLineNumbers` -- row integer vector: Line numbers of the documentation comment
%    - `~+replab.+infra.FunctionLikeData.docLines` -- row cell array of charstring: Documentation comment lines stripped of leading whitespace and leading ``%``
%    - `~+replab.+infra.FunctionLikeData.eq` -- Equality test
%    - `~+replab.+infra.FunctionLikeData.headerStr` -- Tiny single line description of the current object type
%    - `~+replab.+infra.FunctionLikeData.hiddenFields` -- Returns the names of the fields that are not printed as a row vector
%    - `~+replab.+infra.FunctionLikeData.longStr` -- Multi-line description of the current object
%    - `~+replab.+infra.FunctionLikeData.name` -- charstring: Function or method name
%    - `~+replab.+infra.FunctionLikeData.nameFromDeclaration` -- Retrievs the function name from its declaration line
%    - `~+replab.+infra.FunctionLikeData.parse` -- Parses a function or a method and returns the information
%    - `~+replab.+infra.FunctionLikeData.parseAbstractBody` -- Parses the body of an abstract method, used for methods and not functions
%    - `~+replab.+infra.FunctionLikeData.parseBlank` -- 
%    - `~+replab.+infra.FunctionLikeData.parseCode` -- 
%    - `~+replab.+infra.FunctionLikeData.parseComment` -- 
%    - `~+replab.+infra.FunctionLikeData.parseControlStructure` -- Parses a control structure such as 'if' or 'while'
%    - `~+replab.+infra.FunctionLikeData.parseFunctionElement` -- Parses an element appearing in a function or method body
%    - `~+replab.+infra.FunctionLikeData.shortStr` -- Single line text description of the current object
%
