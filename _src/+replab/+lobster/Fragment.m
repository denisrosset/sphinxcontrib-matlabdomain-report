...
%    :class: collapsed
%
%    - `~+replab.+lobster.Fragment.Fragment` -- 
%    - `~+replab.+lobster.Fragment.clean` -- 
%    - `~+replab.+lobster.Fragment.clean_fragment` -- Strip the token start and end tags from the raw text of the framgent and remove whitespace.
%    - `~+replab.+lobster.Fragment.compute_type` -- 
%    - `~+replab.+lobster.Fragment.raw` -- 
%    - `~+replab.+lobster.Fragment.type` -- 
%
% .. raw:: html
%
%    <h3>Own members</h3>
