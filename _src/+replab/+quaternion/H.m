...
%    :class: collapsed
%
%    - `~+replab.+quaternion.H.H` -- Constructor from the expansion as a d=4 real vector space
%    - `~+replab.+quaternion.H.abs` -- 
%    - `~+replab.+quaternion.H.abs2` -- 
%    - `~+replab.+quaternion.H.additionalFields` -- Returns the name/value pairs corresponding to additional fields to be printed
%    - `~+replab.+quaternion.H.conj` -- 
%    - `~+replab.+quaternion.H.ctranspose` -- 
%    - `~+replab.+quaternion.H.disp` -- 
%    - `~+replab.+quaternion.H.end` -- 
%    - `~+replab.+quaternion.H.eq` -- Equality test
%    - `~+replab.+quaternion.H.eye` -- 
%    - `~+replab.+quaternion.H.headerStr` -- Tiny single line description of the current object type
%    - `~+replab.+quaternion.H.hiddenFields` -- Returns the names of the fields that are not printed as a row vector
%    - `~+replab.+quaternion.H.horzcat` -- 
%    - `~+replab.+quaternion.H.i` -- double matrix: Coeffient in the first quaternion unit
%    - `~+replab.+quaternion.H.inv` -- 
%    - `~+replab.+quaternion.H.inverse` -- Scalar inverse
%    - `~+replab.+quaternion.H.j` -- double matrix: Coeffient in the second quaternion unit
%    - `~+replab.+quaternion.H.k` -- double matrix: Coeffient in the third quaternion unit
%    - `~+replab.+quaternion.H.longStr` -- Multi-line description of the current object
%    - `~+replab.+quaternion.H.minus` -- 
%    - `~+replab.+quaternion.H.mrdivide` -- 
%    - `~+replab.+quaternion.H.mtimes` -- 
%    - `~+replab.+quaternion.H.norm` -- 
%    - `~+replab.+quaternion.H.plus` -- 
%    - `~+replab.+quaternion.H.r` -- double matrix: Real part
%    - `~+replab.+quaternion.H.rdivide` -- 
%    - `~+replab.+quaternion.H.real` -- 
%    - `~+replab.+quaternion.H.shortStr` -- Single line text description of the current object
%    - `~+replab.+quaternion.H.subsasgn` -- 
%    - `~+replab.+quaternion.H.subsref` -- 
%    - `~+replab.+quaternion.H.times` -- 
%    - `~+replab.+quaternion.H.transpose` -- 
%    - `~+replab.+quaternion.H.uminus` -- 
%    - `~+replab.+quaternion.H.uplus` -- 
%    - `~+replab.+quaternion.H.vertcat` -- 
%    - `~+replab.+quaternion.H.zeros` -- 
%
