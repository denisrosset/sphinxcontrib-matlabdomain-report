...
%    :class: collapsed
%
%    - `~+replab.+wreathproduct.Common.A` -- replab.CompactGroup: factor of base group
%    - `~+replab.+wreathproduct.Common.imprimitivePermutation` -- Returns the permutation corresponding to the canonical imprimitive action
%    - `~+replab.+wreathproduct.Common.imprimitiveRep` -- Returns an imprimitive representation of this wreath product
%    - `~+replab.+wreathproduct.Common.imprimitiveRepFun` -- Returns an imprimitive representation of this wreath product
%    - `~+replab.+wreathproduct.Common.n` -- integer: Number of copies of the base group
%    - `~+replab.+wreathproduct.Common.primitivePermutation` -- Returns the permutation corresponding to the canonical primitive action
%    - `~+replab.+wreathproduct.Common.primitiveRep` -- Returns a primitive representation of this wreath product
%    - `~+replab.+wreathproduct.Common.primitiveRepFun` -- Returns an primitive representation of this wreath product
%
% .. raw:: html
%
%    <h3>Own members</h3>
