...
%    :class: collapsed
%
%    - `~+replab.IndexedFamily.additionalFields` -- Returns the name/value pairs corresponding to additional fields to be printed
%    - `~+replab.IndexedFamily.at` -- Retrieves a element by position
%    - `~+replab.IndexedFamily.disp` -- 
%    - `~+replab.IndexedFamily.eq` -- Equality test
%    - `~+replab.IndexedFamily.find` -- Returns the index of a given element
%    - `~+replab.IndexedFamily.headerStr` -- Tiny single line description of the current object type
%    - `~+replab.IndexedFamily.hiddenFields` -- Returns the names of the fields that are not printed as a row vector
%    - `~+replab.IndexedFamily.lambda` -- Constructs an indexed family from function handles
%    - `~+replab.IndexedFamily.longStr` -- Multi-line description of the current object
%    - `~+replab.IndexedFamily.sample` -- Returns an element sampled uniformly
%    - `~+replab.IndexedFamily.shortStr` -- Single line text description of the current object
%    - `~+replab.IndexedFamily.size` -- vpi: Number of elements contained in this enumerator
%    - `~+replab.IndexedFamily.toCell` -- Returns a row cell array containing all elements of this family
%
