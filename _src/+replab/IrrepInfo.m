...
%    :class: collapsed
%
%    - `~+replab.IrrepInfo.IrrepInfo` -- 
%    - `~+replab.IrrepInfo.additionalFields` -- Returns the name/value pairs corresponding to additional fields to be printed
%    - `~+replab.IrrepInfo.disp` -- 
%    - `~+replab.IrrepInfo.divisionAlgebra` -- {'R', 'C', 'H', []} : For representations over the reals, the division algebra type if known
%    - `~+replab.IrrepInfo.eq` -- Equality test
%    - `~+replab.IrrepInfo.headerStr` -- Tiny single line description of the current object type
%    - `~+replab.IrrepInfo.hiddenFields` -- Returns the names of the fields that are not printed as a row vector
%    - `~+replab.IrrepInfo.isDivisionAlgebraCanonical` -- logical or []: Whether the division algebra is known to be in the canonical form
%    - `~+replab.IrrepInfo.label` -- char or []: Short description of the irreducible representation, or [] if no description is known
%    - `~+replab.IrrepInfo.longStr` -- Multi-line description of the current object
%    - `~+replab.IrrepInfo.shortStr` -- Single line text description of the current object
%
