...
%    :class: collapsed
%
%    - `~+replab.LawsCollection.LawsCollection` -- 
%    - `~+replab.LawsCollection.child` -- 
%    - `~+replab.LawsCollection.children` -- 
%    - `~+replab.LawsCollection.getTestCases` -- 
%    - `~+replab.LawsCollection.nChildren` -- 
%
% .. raw:: html
%
%    <h3>Own members</h3>
