...
%    :class: collapsed
%
%    - `~+replab.RandomBag.G` -- Group definition
%    - `~+replab.RandomBag.RandomBag` -- Constructs a random bag from generators
%    - `~+replab.RandomBag.additionalFields` -- Returns the name/value pairs corresponding to additional fields to be printed
%    - `~+replab.RandomBag.disp` -- 
%    - `~+replab.RandomBag.eq` -- Equality test
%    - `~+replab.RandomBag.headerStr` -- Tiny single line description of the current object type
%    - `~+replab.RandomBag.hiddenFields` -- Returns the names of the fields that are not printed as a row vector
%    - `~+replab.RandomBag.longStr` -- Multi-line description of the current object
%    - `~+replab.RandomBag.sample` -- 
%    - `~+replab.RandomBag.shortStr` -- Single line text description of the current object
%    - `~+replab.RandomBag.x` -- 1 x r cell array representing the contents of the bag
%    - `~+replab.RandomBag.x0` -- Last generated sample
%
