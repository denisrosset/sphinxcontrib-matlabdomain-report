...
%    :class: collapsed
%
%    - `~+replab.SedumiData.At` -- double: Data matrix of size n x m
%    - `~+replab.SedumiData.G` -- cell array of generators as permutations
%    - `~+replab.SedumiData.K` -- struct: Cone specification (Sedumi data)
%    - `~+replab.SedumiData.SedumiData` -- 
%    - `~+replab.SedumiData.b` -- double: Constraint right hand side (Sedumi data)
%    - `~+replab.SedumiData.blockDiagonalData` -- 
%    - `~+replab.SedumiData.blockDiagonalize` -- 
%    - `~+replab.SedumiData.c` -- double: Primal objective (Sedumi data)
%    - `~+replab.SedumiData.fromMatFile` -- 
%    - `~+replab.SedumiData.m` -- number of dual variables
%    - `~+replab.SedumiData.project` -- 
%    - `~+replab.SedumiData.rep` -- `.Rep`: group representation commuting with the SDP block
%    - `~+replab.SedumiData.rho` -- cell array of generator images defining the representation
%    - `~+replab.SedumiData.s` -- size of single SDP block present
%    - `~+replab.SedumiData.saveBlockDiagonalizedMatFile` -- 
%    - `~+replab.SedumiData.toYalmip` -- 
%
% .. raw:: html
%
%    <h3>Own members</h3>
