...
%    :class: collapsed
%
%    - `~+replab.Str.additionalFields` -- Returns the name/value pairs corresponding to additional fields to be printed
%    - `~+replab.Str.disp` -- 
%    - `~+replab.Str.eq` -- Equality test
%    - `~+replab.Str.headerStr` -- Tiny single line description of the current object type
%    - `~+replab.Str.hiddenFields` -- Returns the names of the fields that are not printed as a row vector
%    - `~+replab.Str.longStr` -- Multi-line description of the current object
%    - `~+replab.Str.shortStr` -- Single line text description of the current object
%
% .. raw:: html
%
%    <h3>Own members</h3>
